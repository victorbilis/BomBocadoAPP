...
public class getPrecoDesc extends AsyncTask<String,String,String> {
    Context context;
    String data = "";
    String res = "";
    public getPrecoDesc(String data, Context context)
    {
    ...
    protected String doInBackground(String... strings) {
        try{
            URL url = new URL("http://bombocado.esy.es/listPrecoDesc.php");
