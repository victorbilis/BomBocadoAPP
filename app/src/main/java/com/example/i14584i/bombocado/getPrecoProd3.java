...
public class getPrecoProd3 extends AsyncTask<String,String,String> {
    Context context;
    String data = "";
    String res = "";
    ...
    public getPrecoProd3(String data, Context context, TextView preco_total, double preco)
    {
