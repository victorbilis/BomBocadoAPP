...
public class getProd extends AsyncTask<String,String,String> {
    Context context;
    ListView listView;
    String data = "";
    String res = "";
    public getProd(Context context, ListView listView, String data)
    {
    ...
    protected String doInBackground(String... strings) {
        try{
            URL url = new URL("http://bombocado.esy.es/listNomeProd.php");
